    ...
    <footer className="bg-black text-zinc-400 py-12">
      <div className="container mx-auto px-4">
            ...
            <div className="mt-6">
              ...
              <form className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-zinc-800 rounded-l-md focus:outline-none focus:ring-1 focus:ring-red-500"
                />
                <button
                  type="submit"
        ...
        <div className="border-t border-zinc-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">© 2023 Royal Enfield. All rights reserved.</p>
